...
def parse_arguments(is_training=True):
    ...
    parser.add_argument("--resume_model", type=str, default='/workspace/weight/resnet101_512.pth',
    ...
    # Paths parameters
    parser.add_argument("--dataset_folder", type=str, default="/nfs_shared/STR_Data/roadview/cosplace/cubemap/1796",
                        help="path of the folder with train/val/test sets")
    parser.add_argument("--save_dir", type=str, default="result",
                        help="name of directory on which to save the logs, under logs/save_dir")
    parser.add_argument("--db_dir", type=str, default="/nfs_shared/STR_Data/roadview/cosplace/cubemap/1796",
                        help="db directory")
    parser.add_argument("--query_dir", type=str, default="/workspace/pair/cubemap/queries", help="query directory")
    parser.add_argument("--gt_dir", type=str, default=False, help="gt directory")
    parser.add_argument("--feature_path", type=str, default="feature/database_2019.npy", help="npy file")
    parser.add_argument("--result_path", type=str, default="workspace/result", help="result directory")
    parser.add_argument("--result_txt_name", type=str, default="result.txt", help="result file name")
    parser.add_argument("--recall_value", type=int, default=10, help="recall max value")
